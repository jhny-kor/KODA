...
- KODA `platforms/linux/suite/README.ko.md`, `TROUBLESHOOTING.ko.md`, `koda-suite`, `compose.integration.yaml`.
- KODA `platforms/linux/patch/README.ko.md`: 20260906 전용 패치·이미지 보존·롤백.
